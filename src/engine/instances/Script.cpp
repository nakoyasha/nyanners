...
namespace Nyanners::Scripting {
    auto scriptRegistrator = ReflectionDescriptorRegistry::instance()->create_registrator([]() {
        Services::ReflectionService::create_descriptor("Script", {"Instance"})
                .add_property_chained<Script, std::string, &Script::get_file_path, &Script::set_file>("Path", String)
