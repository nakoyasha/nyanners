...
namespace Nyanners::Services {
    ...
    public:
        ...
        static ReflectionDescriptor &create_descriptor(const std::string &className, const std::vector<std::string> &parents, const std::vector<ReflectionInstanceFlags> &flags = {});
