...
namespace Nyanners::Scripting {
    static auto uiElement = ReflectionDescriptorRegistry::instance()->create_registrator([]() {
        Services::ReflectionService::create_descriptor("UIElement", {"Drawable", "Instance"}, {ReflectionInstanceFlags::NotCreatable})
            ...
            .add_property_chained<UIElement, glm::vec2, &UIElement::get_absolute_size>("AbsoluteSize", Vector2, {ReflectionPropertyFlags::NotSerializable})
            .add_property_chained<UIElement, glm::vec2, &UIElement::get_absolute_position>("AbsolutePosition", Vector2, {ReflectionPropertyFlags::NotSerializable})
